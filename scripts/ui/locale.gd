...
const STRINGS := {
	...
	"how_to.3.body": {"zh": "点金框手牌，再点你的支援线空位。没有额外目标时会立刻放下。", "en": "Select a gold-bordered hand card, then a Support Line slot. Simple deploys land immediately."},
	...
	"coach.support_slot": {"zh": "点高亮的支援线空位。", "en": "Choose a highlighted Support Line slot."},
	"coach.frontline_slot": {"zh": "点高亮的前线空位。", "en": "Choose a highlighted Frontline slot."},
	"coach.target": {"zh": "点高亮的目标。", "en": "Choose a highlighted target."},
	"coach.deploy": {"zh": "点金框手牌部署。当前信用 %d。", "en": "Select a highlighted card to deploy. You have %d Credit."},
	"coach.move": {"zh": "点可行动的单位，再点高亮前线空位。", "en": "Select a ready unit, then choose a highlighted Frontline slot."},
	"coach.attack": {"zh": "点可行动的单位，再点高亮目标。", "en": "Select a ready unit, then choose a highlighted target."},
